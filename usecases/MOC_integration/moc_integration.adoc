...
This additional step is helpful for people who build ChRIS plugin/services to test/debug the application locally before testing it on the cloud environment.
...
Download CodeReady Containers binaries with an embedded OpenShift disk image from https://cloud.redhat.com/openshift/create/local
