...
image:Openstack-project.png[Openstack Project]
...
Note: Make sure that you have OC libraries installed on your system.

image:Openshift-project.png[Openshift Project]
